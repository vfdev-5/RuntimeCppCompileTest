...
#    foreach(it ${DLL_LIST})
#        message("dll_name : ${it}")
    if(NOT INSTALL_QT_DLLS_PATH)
    SET(INSTALL_QT_DLLS_PATH bin)
    endif()

    INSTALL(FILES ${DLL_LIST} DESTINATION ${INSTALL_QT_DLLS_PATH})
#    endforeach()
    # ICU for Qt5
    FILE(GLOB icu_dlls "${QT_BIN_DIR}/icu*.dll")
    INSTALL(FILES ${icu_dlls} DESTINATION ${INSTALL_QT_DLLS_PATH})
